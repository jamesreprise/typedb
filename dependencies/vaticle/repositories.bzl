...
def vaticle_dependencies():
    git_repository(
        ...
        commit = "4ca664233f4022a61196fc3d5be242605b2bc898", # sync-marker: do not remove this comment, this is used for sync-dependencies by @vaticle_dependencies
    )
...
def vaticle_typedb_protocol():
    git_repository(
        ...
        commit = "0f546a77fe0f5dca9990ac7a4b5b9f5e31d2982c", # sync-marker: do not remove this comment, this is used for sync-dependencies by @vaticle_typedb_protocol
    )
...
def vaticle_typedb_behaviour():
    git_repository(
        ...
        commit = "403fd2cbd4d338dd8627ca79867140ae2451a4ce", # sync-marker: do not remove this comment, this is used for sync-dependencies by @vaticle_typedb_behaviour
    )
